...
def build_translation_prompt(texts: list[str], target_lang: str, source_lang: str) -> str:
    ...
    return (
        ...
        f"ticker symbols, brand names, product names, acronyms/abbreviations "
        f"(e.g. JLR, TML, CV, PV, EBITDA, FY26E, QoQ, YoY, BEV, SoTP, CAGR, NM, CMP).\n"
        f"4. Preserve capitalization style (ALL CAPS → ALL CAPS).\n"
